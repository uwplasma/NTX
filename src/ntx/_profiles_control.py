"""The control parameterization profiles are optimized through.

Basis and scalar controls that map a small design vector onto a full radial
profile, so an optimizer sees a well-conditioned space. Types live in _profiles.
"""
