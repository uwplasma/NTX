"""Which artifacts each physics gate is backed by, at zero and finite beta.

Declares ARTIFACT_GATES. Sits below the gate registry so the registry can
aggregate it with the analytical gates without a cycle.
"""
