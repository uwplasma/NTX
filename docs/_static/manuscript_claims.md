...
- W7-X imported-workflow bootstrap-current convergence reaches a maximum relative error of `1.831e-02` on the fine `25 x 25 x 64` grid.
...
- The prepared derivative path reaches a best observed speedup of `3.848x` on the benchmarked electric-field scan.
