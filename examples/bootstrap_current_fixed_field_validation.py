...
def _compute_ntx_neopax_profile(case: FixedFieldCase, rho: np.ndarray) -> dict[str, np.ndarray]:
    ...
    return {
        ...
        "electron_L31": _interp_profile(rho_field, np.asarray(lij[0, :, 2, 0], dtype=float), rho),
        "ion_L31": _interp_profile(rho_field, np.asarray(lij[1, :, 2, 0], dtype=float), rho),
        "electron_L32": _interp_profile(rho_field, np.asarray(lij[0, :, 2, 1], dtype=float), rho),
        "ion_L32": _interp_profile(rho_field, np.asarray(lij[1, :, 2, 1], dtype=float), rho),
        "electron_L33": _interp_profile(rho_field, np.asarray(lij[0, :, 2, 2], dtype=float), rho),
        "ion_L33": _interp_profile(rho_field, np.asarray(lij[1, :, 2, 2], dtype=float), rho),
        ...
        "electron_L31_grid": np.asarray(lij[0, :, 2, 0], dtype=float),
        "ion_L31_grid": np.asarray(lij[1, :, 2, 0], dtype=float),
        "electron_L32_grid": np.asarray(lij[0, :, 2, 1], dtype=float),
        "ion_L32_grid": np.asarray(lij[1, :, 2, 1], dtype=float),
        "electron_L33_grid": np.asarray(lij[0, :, 2, 2], dtype=float),
        "ion_L33_grid": np.asarray(lij[1, :, 2, 2], dtype=float),
